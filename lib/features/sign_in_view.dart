...
class _SignInState extends BaseStateWidget<SignInView> {
  ...
  Widget buildApp(BuildContext context) {
    return Consumer<SignInProvider>(
        builder: (BuildContext context, SignInProvider provider, Widget child) {
              ...
              Container(
                child: KeyboardAvoider(
                  ...
                  child: Column(
                    children: <Widget>[
                      Image.asset(
                        "assets/icons/banner_30_day.png",
                      ),
                      Container(
  ...
  void _callSignIn() {
    ...
    _userProvider
        ...
        .then((value) => {
              if (value == "success")
                {
                  MySharePref.saveUserInfo(_userProvider.user),
                ...
                onApiError(_userProvider.apiError)
            });
  }
